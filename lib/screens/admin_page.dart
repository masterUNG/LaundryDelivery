...
import 'package:testdb/screens/grid_customer.dart';
...
class _AdminPageState extends State<AdminPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Offier : ${widget.userModel.customerName}'),
        actions: [
          WidgetButton(
              onPressed: () {
                Get.to( GridCustomer(userModel: widget.userModel,));
              },
              text: 'Chat'),
      ...
      body: Obx(
        () => appController.orderWashModels.isEmpty
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                                appController.orderWashModels[index].dateStart),
